...
<!-- 							 <li class="single-block"><a href="http://itsp2014.stab-iitb.org/" class="btn">Last Year's Documentation &nbsp</a> </li>
 -->					     @endif
							 <li class="single-block"><a href="{{URL::route('club.robo.XLR8_2015.index')}}" class="btn">&emsp;&emsp;XLR8&emsp;&emsp;</a> &emsp; <a class="btn" href="{{URL::Route('robotics-club')}}/tshirt">Robotics Club T-Shirt</a> </li>	
